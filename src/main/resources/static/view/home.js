let template = // html
`
<div style='height: calc(100% - 40px);border-bottom:1px solid black;background:#fff8f8;'>
	<router-view></router-view>
</div>
<div style='text-align: center;text-align: center;height: 40px;line-height: 40px;background:#ffdefc;'>
